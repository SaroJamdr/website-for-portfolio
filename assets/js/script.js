...
document.addEventListener('visibilitychange',
    function () {
        if (document.visibilityState === "visible") {
            document.title = "Portfolio | Saroj Jamdar";
...
var typed = new Typed(".typing-text", {
    strings: ["Backend Development","Frontend Development", "Web designing", "API Development","Full Stack Development", "Wordpress Design"],
    loop: true,
    typeSpeed: 60,
    backSpeed: 30,
    backDelay: 500,
...
srtop.reveal('.home .instagram', { interval: 1200 });
